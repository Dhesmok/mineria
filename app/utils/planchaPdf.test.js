...
describe("calcularEscalaMedida", () => {
  ...
  test("en móvil (< 768 px) limita a 2500 px y presupuesto de 5 Megapíxeles", () => {
    window.innerWidth = 1280
    ...
    expect(anchoEsperado).toBeLessThanOrEqual(2500)
    expect(pixeles).toBeLessThanOrEqual(5000001)
    expect(escala).toBeLessThan(escalaEscritorio)
  })

  test("en móvil con reintento (intento 2) reduce a 1400 px y 2 Megapíxeles", () => {
    ...
    expect(ancho2).toBeLessThanOrEqual(1400.01)
    expect(ancho2 * alto2).toBeLessThanOrEqual(2000001)
  })
  ...
  test("presupuesto estricto: el redondeo de ancho y alto nunca excede los límites", () => {
    ...
    for (const f of formatos) {
      ...
      expect(wEntero).toBeLessThanOrEqual(2500)
      expect(wEntero * hEntero).toBeLessThanOrEqual(5000000)
    }
  })

  test("contraejemplo de Astra (40000 x 35000): cumple estrictamente <= 5 MP y <= 2500 px", () => {
    window.innerWidth = 412
    ...
    expect(w * h).toBeLessThanOrEqual(5000000)
  })
  ...
  test("desbordamiento aritmético a Infinity (1e200 x 1e200): no colapsa ni devuelve 1", () => {
    ...
    expect(effW).toBeLessThanOrEqual(2500)
    expect(effW * effH).toBeLessThanOrEqual(5000000)
  })
