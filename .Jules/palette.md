...
## 2025-03-09 - Async Button Loading States
**Learning:** Adding a spinner indicator to export buttons clearly indicates an ongoing process rather than a static visual state, decreasing the likelihood of user confusion while waiting on long requests.
**Action:** Always add visual indicators (`Loader2`) alongside informative text for buttons triggering async operations (like fetches).
